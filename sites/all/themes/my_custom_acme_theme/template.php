...
// & here means, add our value to the $variables variable -- because there is already an existing aray of $variables variable

function my_custom_acme_theme_preprocess_page(&$variables) {
	$variables['copyright'] = t("Copyright " . date('Y')); // PHP has a function that can get the current date -- this just passes the year argument
														   // wrapping this string in t(); exposes the string to Drupal to give it the ability to add translations for it
}
